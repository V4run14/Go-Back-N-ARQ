...
def main():
    parser = argparse.ArgumentParser(
        description="Run SR Task 2 (MSS sweep) against a remote server.")
    ...
    parser.add_argument("--output", type=Path, default=Path("sr_task2_remote.csv"),
    ...
    rows = []
    print(f"Running SR Task 2 remote sweep to {args.host}:{args.port}")
